...
export default class BaseLevel extends Phaser.Scene {
    constructor(levelNumber, totalCollectables, gems, worldName, ranking) {
        ...
        this.setLevelState = null;
        this.setLevelWorld = null;
        this.setLevelSelectorShow = null;
    ...
    preload() {
        ...
        this.load.tilemapTiledJSON('map6', 'assets/levels/the_haunted_forest/map1.tmj');
        this.load.tilemapTiledJSON('map7', 'assets/levels/the_haunted_forest/map1.tmj');
        this.load.tilemapTiledJSON('map8', 'assets/levels/the_haunted_forest/map2.tmj');
        this.load.tilemapTiledJSON('map9', 'assets/levels/the_haunted_forest/map2.tmj');
        ...
        this.load.spritesheet('fish_swimming', 'assets/fish/anchovy_swimming.png', 
            { frameWidth: 503, frameHeight: 169 }),
        this.load.atlas('mouse', 'assets/players/mouse/mouse.png', 
        'assets/players/mouse/mouse.json');
        // Collectables
        this.load.spritesheet('gem', 'assets/gems/gem.png',
            { frameWidth: 196, frameHeight: 256 });
        ...
        this.load.atlas('lantern', 'assets/lantern/lantern.png',
        ...
        this.load.atlas('spider', 'assets/spider/spider.png', 
        ...
        this.load.atlas('fence', 'assets/fence/wooden_fence/wooden_fence.png', 
          'assets/fence/wooden_fence/wooden_fence.json');
        this.load.atlas('fence_metal', 'assets/fence/metal_fence/metal_fence.png',
    ...
    init(data) {
        if(data.setLevelState) {
            this.setLevelState = data?.setLevelState;
            data?.setLevelState(this.level);
        }
        if(data.setLevelWorld) {
            this.setLevelWorld = data?.setLevelWorld;
            data?.setLevelWorld(this.worldName);
        }
        if(data.setLevelSelectorShow) {
            this.setLevelSelectorShow = data?.setLevelSelectorShow;
            data?.setLevelSelectorShow(false);
        }
        if(data.setIsLoading) {
    ...
    updateReactLevelState(setLevel, setLevelWorld, setLevelSelectorShow, setIsLoading, setAccountData) {
        this.setLevelState = setLevel;
        setLevel(this.level);

        this.setLevelWorld = setLevelWorld;
        setLevelWorld(this.worldName);

        this.setLevelSelectorShow = setLevelSelectorShow;
        setLevelSelectorShow(false);

        this.setIsLoading = setIsLoading;
        // setIsLoading(true);

        this.setAccountData = setAccountData;
