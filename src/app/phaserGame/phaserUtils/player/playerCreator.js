    ...
    switch (location.type) {
      case PLAYER_TYPES.GHOST:
        ...
        player = scene.physics.add
          .sprite(0, 0, PLAYER_TYPES.GHOST)
          .setOrigin(0.5, 0.55);
        player
          .setScale(location.scale || 0.18)
          .setDepth(1)
          .setSize(340, 340)
          .setOffset(160, 260);
        player.anims
          .play(GHOST_APPEAR_ANIMATION)
