...
const players_locations = [
  {type: PLAYER_TYPES.MOUSE, x:125, y:675, name: "mouse[0]"},
  {type: PLAYER_TYPES.MOUSE, x:265, y:675, name: "mouse[1]"},
  {type: PLAYER_TYPES.MOUSE, x:405, y:675, name: "mouse[2]"},
  {type: PLAYER_TYPES.MOUSE, x:545, y:675, name: "mouse[3]"}
];

export default class Level19 extends GhostlyCabniBaseLevel {
  constructor() {
    super(19,3, COLLECTABLES_LOCATIONS, {best: 2, minimum: 3});
  }
