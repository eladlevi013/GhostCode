...
const PLAYERS_LOCATIONS = [
  {type: PLAYER_TYPES.MOUSE, x:200, y:450, name: "mouse[0]"},
  {type: PLAYER_TYPES.MOUSE, x:340, y:450, name: "mouse[1]"},
  {type: PLAYER_TYPES.MOUSE, x:480, y:450, name: "mouse[2]"}
];

export default class Level18 extends GhostlyCabniBaseLevel {
  constructor() {
    super(18,6, COLLECTABLES_LOCATIONS, {best: 3, minimum: 4});
  }
