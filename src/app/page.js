...
const MainPage = () => {
  // get states of auth panel from layout
...
>
  ...
  style={{ marginTop: '30px' }}
>
        <div className='mainPageTitle' style={{marginTop: "80px", }}>COLLECT THE BADGES:</div>
        </motion.div>
...
>
  ...
  style={{ marginTop: '30px' }}
>
        <div className='mainPageTitle' style={{marginTop: "80px"}}>JOIN US:</div>
